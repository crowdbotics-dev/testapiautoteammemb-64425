...
## Project Structure
    ...
    ├── testapiautoteammemb_64425  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_64425`
...
2. Clone this repo and `cd testapiautoteammemb_64425`
